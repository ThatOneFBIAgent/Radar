...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 19), // void()(double const *, double const *, double const *, int, double *)
...
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // double *
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION, 19), // void()(double const *, int, double, double *)
...
/* 13 */ _CFFI_OP(_CFFI_OP_FUNCTION, 19), // void()(double const *, int, int, double *)
...
static void _cffi_d_compute_magnitude(double const * x0, double const * x1, double const * x2, int x3, double * x4)
{
  compute_magnitude(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_compute_magnitude(PyObject *self, PyObject *args)
{
  double const * x0;
  double const * x1;
  double const * x2;
  ...
  if (!PyArg_UnpackTuple(args, "compute_magnitude", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
...
#else
#  define _cffi_f_compute_magnitude _cffi_d_compute_magnitude
#endif

static void _cffi_d_ema_smooth(double const * x0, int x1, double x2, double * x3)
{
  ema_smooth(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_ema_smooth(PyObject *self, PyObject *args)
{
  double const * x0;
  int x1;
  double x2;
  ...
  if (!PyArg_UnpackTuple(args, "ema_smooth", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_ema_smooth _cffi_d_ema_smooth
#endif

static void _cffi_d_wma_smooth(double const * x0, int x1, int x2, double * x3)
{
  wma_smooth(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_wma_smooth(PyObject *self, PyObject *args)
{
  double const * x0;
  int x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "wma_smooth", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_wma_smooth _cffi_d_wma_smooth
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "compute_magnitude", (void *)_cffi_f_compute_magnitude, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_compute_magnitude },
  { "ema_smooth", (void *)_cffi_f_ema_smooth, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 7), (void *)_cffi_d_ema_smooth },
  { "wma_smooth", (void *)_cffi_f_wma_smooth, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 13), (void *)_cffi_d_wma_smooth },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__radar_signal(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__radar_signal(void) { return NULL; }
#  else
     init_radar_signal(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__radar_signal(void)
{
  return _cffi_init("_radar_signal", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_radar_signal(void)
{
  _cffi_init("_radar_signal", 0x2601, &_cffi_type_context);
}
#endif
